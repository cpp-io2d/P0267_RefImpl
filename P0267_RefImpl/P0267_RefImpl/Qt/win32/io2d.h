...
#include "io2d_qt_win32.h"

namespace std::experimental::io2d {
	inline namespace v1 {
		using default_graphics_math = _Graphics_math_float_impl;
		using default_graphics_surfaces = _Qt_io2d::_Qt_graphics_surfaces<default_graphics_math>;
		using commands = basic_commands<default_graphics_surfaces>;
		...
		using font = basic_font<default_graphics_surfaces>;
		using text_props = basic_text_props<default_graphics_surfaces>;
	}
}
#endif
