...
namespace std::experimental::io2d {
	inline namespace v1 {
		namespace _Cairo {
			...
			//}
			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::paint_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_paint(const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				return paint_data_type{ nullopt, b, bp, rp, cl };
			}
			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::paint_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_paint(::std::reference_wrapper<basic_image_surface<_Cairo_graphics_surfaces<GraphicsMath>>> sfc, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
			...
			template<class GraphicsMath>
			inline basic_brush<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush(const paint_data_type& data) noexcept {
				return data.b;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(paint_data_type& data, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp) noexcept {
				data.bp = bp;
			}
			template<class GraphicsMath>
			inline basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(const paint_data_type& data) noexcept {
				return data.bp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(paint_data_type& data, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp) noexcept {
				data.rp = rp;
			}
			template<class GraphicsMath>
			inline basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(const paint_data_type& data) noexcept {
				return data.rp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(paint_data_type& data, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				data.cl = cl;
			}
			template<class GraphicsMath>
			inline basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(const paint_data_type& data) noexcept {
				return data.cl;
			}

			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::stroke_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_stroke(const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_interpreted_path<_Cairo_graphics_surfaces<GraphicsMath>>& ip, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>>& sp, const basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>>& d, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				return stroke_data_type{ nullopt, b, ip, bp, sp, d, rp, cl };
			}
			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::stroke_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_stroke(reference_wrapper<basic_image_surface<_Cairo_graphics_surfaces<GraphicsMath>>> sfc, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_interpreted_path<_Cairo_graphics_surfaces<GraphicsMath>>& ip, const basic_brush_props<graphics_surfaces_type>& bp, const basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>>& sp, const basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>>& d, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
			...
			template<class GraphicsMath>
			inline basic_brush<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush(const stroke_data_type& data) noexcept {
				return data.b;
			}
			template<class GraphicsMath>
			...
			template<class GraphicsMath>
			inline basic_interpreted_path<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::path(const stroke_data_type& data) noexcept {
				return data.ip;
			}
			template<class GraphicsMath>
			...
			template<class GraphicsMath>
			inline basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::stroke_props(const stroke_data_type& data) noexcept {
				return data.sp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::dashes(stroke_data_type& data, const basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>>& d) noexcept {
				data.d = d;
			}
			template<class GraphicsMath>
			inline basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::dashes(const stroke_data_type& data) noexcept {
				return data.d;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(stroke_data_type& data, const basic_brush_props<graphics_surfaces_type>& bp) noexcept {
				data.bp = bp;
			}
			template<class GraphicsMath>
			inline basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(const stroke_data_type& data) noexcept {
				return data.bp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(stroke_data_type& data, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp) noexcept {
				data.rp = rp;
			}
			template<class GraphicsMath>
			inline basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(const stroke_data_type& data) noexcept {
				return data.rp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(stroke_data_type& data, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				data.cl = cl;
			}
			template<class GraphicsMath>
			inline basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(const stroke_data_type& data) noexcept {
				return data.cl;
			}

			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::fill_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_fill(const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_interpreted_path<_Cairo_graphics_surfaces<GraphicsMath>>& ip, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
			...
			template<class GraphicsMath>
			inline basic_brush<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush(const fill_data_type& data) noexcept {
				return data.b;
			}
			template<class GraphicsMath>
			...
			template<class GraphicsMath>
			inline basic_interpreted_path<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::path(const fill_data_type& data) noexcept {
				return data.ip;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(fill_data_type& data, const basic_brush_props<graphics_surfaces_type>& bp) noexcept {
				data.bp = bp;
			}
			template<class GraphicsMath>
			inline basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(const fill_data_type& data) noexcept {
				return data.bp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(fill_data_type& data, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp) noexcept {
				data.rp = rp;
			}
			template<class GraphicsMath>
			inline basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(const fill_data_type& data) noexcept {
				return data.rp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(fill_data_type& data, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				data.cl = cl;
			}
			template<class GraphicsMath>
			inline basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(const fill_data_type& data) noexcept {
				return data.cl;
			}

			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::mask_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_mask(const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& mb, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_mask_props<_Cairo_graphics_surfaces<GraphicsMath>>& mp, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				return mask_data_type{ nullopt, b, mb, bp, mp, rp, cl };
			}
			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::mask_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_mask(reference_wrapper<basic_image_surface<_Cairo_graphics_surfaces<GraphicsMath>>> sfc, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& mb, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_mask_props<_Cairo_graphics_surfaces<GraphicsMath>>& mp, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
			...
			template<class GraphicsMath>
			inline basic_brush<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush(const mask_data_type& data) noexcept {
				return data.b;
			}
			template<class GraphicsMath>
			...
			template<class GraphicsMath>
			inline basic_brush<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::mask_brush(const mask_data_type& data) noexcept {
				return data.mb;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(mask_data_type& data, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp) noexcept {
				data.bp = bp;
			}
			template<class GraphicsMath>
			inline basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(const mask_data_type& data) noexcept {
				return data.bp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::mask_props(mask_data_type& data, const basic_mask_props<_Cairo_graphics_surfaces<GraphicsMath>>& mp) noexcept {
				data.mp = mp;
			}
			template<class GraphicsMath>
			inline basic_mask_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::mask_props(const mask_data_type& data) noexcept {
				return data.mp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(mask_data_type& data, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp) noexcept {
				data.rp = rp;
			}
			template<class GraphicsMath>
			inline basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(const mask_data_type& data) noexcept {
				return data.rp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(mask_data_type& data, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				data.cl = cl;
			}
			template<class GraphicsMath>
			inline basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(const mask_data_type& data) noexcept {
				return data.cl;
			}

			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::draw_text_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_draw_text(const basic_point_2d<GraphicsMath>& pt, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_font<_Cairo_graphics_surfaces<GraphicsMath>>& f, ::std::string text, const basic_text_props<_Cairo_graphics_surfaces<GraphicsMath>>& tp, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>>& sp, const basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>>& d, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				return draw_text_data_type{ nullopt, pt, b, f, text, tp, bp, sp, d, rp, cl };
			}
			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::draw_text_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_draw_text(reference_wrapper<basic_image_surface<_Cairo_graphics_surfaces<GraphicsMath>>> sfc, const basic_point_2d<GraphicsMath>& pt, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_font<_Cairo_graphics_surfaces<GraphicsMath>>& f, ::std::string text, const basic_text_props<_Cairo_graphics_surfaces<GraphicsMath>>& tp, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>>& sp, const basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>>& d, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				return draw_text_data_type{ sfc, pt, b, f, text, tp, bp, sp, d, rp, cl };
			}
			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::draw_text_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_draw_text(const basic_bounding_box<GraphicsMath>& bb, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_font<_Cairo_graphics_surfaces<GraphicsMath>>& f, ::std::string text, const basic_text_props<_Cairo_graphics_surfaces<GraphicsMath>>& tp, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>>& sp, const basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>>& d, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				return draw_text_data_type{ nullopt, bb, b, f, text, tp, bp, sp, d, rp, cl };
			}
			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::surfaces::draw_text_data_type _Cairo_graphics_surfaces<GraphicsMath>::surfaces::create_draw_text(reference_wrapper<basic_image_surface<_Cairo_graphics_surfaces<GraphicsMath>>> sfc, const basic_bounding_box<GraphicsMath>& bb, const basic_brush<_Cairo_graphics_surfaces<GraphicsMath>>& b, const basic_font<_Cairo_graphics_surfaces<GraphicsMath>>& f, ::std::string text, const basic_text_props<_Cairo_graphics_surfaces<GraphicsMath>>& tp, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp, const basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>>& sp, const basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>>& d, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
			...
			template<class GraphicsMath>
			inline basic_brush<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush(const draw_text_data_type& data) noexcept {
				return data.b;
			}
			template<class GraphicsMath>
			...
			template<class GraphicsMath>
			inline basic_font<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::font(const draw_text_data_type& data) noexcept {
				return data.f;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::text(draw_text_data_type& data, ::std::string t) noexcept {
				data.text = t;
			}
			template<class GraphicsMath>
			inline ::std::string _Cairo_graphics_surfaces<GraphicsMath>::surfaces::text(const draw_text_data_type& data) noexcept {
				return data.text;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::text_props(draw_text_data_type& data, const basic_text_props<_Cairo_graphics_surfaces<GraphicsMath>>& tp) noexcept {
				data.tp = tp;
			}
			template<class GraphicsMath>
			inline basic_text_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::text_props(const draw_text_data_type& data) noexcept {
				return data.tp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(draw_text_data_type& data, const basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>>& bp) noexcept {
				data.bp = bp;
			}
			template<class GraphicsMath>
			inline basic_brush_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::brush_props(const draw_text_data_type& data) noexcept {
				return data.bp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::stroke_props(draw_text_data_type& data, const basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>>& sp) noexcept {
				data.sp = sp;
			}
			template<class GraphicsMath>
			inline basic_stroke_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::stroke_props(const draw_text_data_type& data) noexcept {
				return data.sp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::dashes(draw_text_data_type& data, const basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>>& d) noexcept {
				data.d = d;
			}
			template<class GraphicsMath>
			inline basic_dashes<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::dashes(const draw_text_data_type& data) noexcept {
				return data.d;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(draw_text_data_type& data, const basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>>& rp) noexcept {
				data.rp = rp;
			}
			template<class GraphicsMath>
			inline basic_render_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::render_props(const draw_text_data_type& data) noexcept {
				return data.rp;
			}
			template<class GraphicsMath>
			inline void _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(draw_text_data_type& data, const basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>>& cl) noexcept {
				data.cl = cl;
			}
			template<class GraphicsMath>
			inline basic_clip_props<_Cairo_graphics_surfaces<GraphicsMath>> _Cairo_graphics_surfaces<GraphicsMath>::surfaces::clip_props(const draw_text_data_type& data) noexcept {
				return data.cl;
			}
