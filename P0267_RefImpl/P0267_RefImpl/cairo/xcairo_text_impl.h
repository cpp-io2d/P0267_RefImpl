...
namespace std::experimental::io2d {
	inline namespace v1 {
		namespace _Cairo {
			...
			// text_props
			template<class GraphicsMath>
			inline typename _Cairo_graphics_surfaces<GraphicsMath>::text::text_props_data_type _Cairo_graphics_surfaces<GraphicsMath>::text::create_text_props(float scl, font_size_units fsu, float fontsize, bool kern, font_antialias aa, font_stretching stretch, bool strike_through, font_line fl) noexcept {
