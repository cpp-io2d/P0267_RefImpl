...
namespace std::experimental::io2d {
	inline namespace v1 {
		...
		template<class GraphicsSurfaces>
		inline basic_commands<GraphicsSurfaces>::paint::paint(const basic_brush<GraphicsSurfaces>& b, const basic_brush_props<GraphicsSurfaces>& bp, const basic_render_props<GraphicsSurfaces>& rp, const basic_clip_props<GraphicsSurfaces>& cl) noexcept
			: _Data(GraphicsSurfaces::surfaces::create_paint(b, bp, rp, cl)) {
		}
		template<class GraphicsSurfaces>
		inline basic_commands<GraphicsSurfaces>::paint::paint(reference_wrapper<basic_image_surface<GraphicsSurfaces>> sfc, const basic_brush<GraphicsSurfaces>& b, const basic_brush_props<GraphicsSurfaces>& bp, const basic_render_props<GraphicsSurfaces>& rp, const basic_clip_props<GraphicsSurfaces>& cl) noexcept
		...
		template<class GraphicsSurfaces>
		inline basic_brush<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::paint::brush() const noexcept {
			return GraphicsSurfaces::surfaces::brush(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::paint::brush_props(const basic_brush_props<GraphicsSurfaces>& bp) noexcept {
			GraphicsSurfaces::surfaces::brush_props(_Data, bp);
		}
		template<class GraphicsSurfaces>
		inline basic_brush_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::paint::brush_props() const noexcept {
			return GraphicsSurfaces::surfaces::brush_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::paint::render_props(const basic_render_props<GraphicsSurfaces>& rp) noexcept {
			GraphicsSurfaces::surfaces::render_props(_Data, rp);
		}
		template<class GraphicsSurfaces>
		inline basic_render_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::paint::render_props() const noexcept {
			return GraphicsSurfaces::surfaces::render_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::paint::clip_props(const basic_clip_props<GraphicsSurfaces>& cl) noexcept {
			GraphicsSurfaces::surfaces::clip_props(_Data, cl);
		}
		template<class GraphicsSurfaces>
		inline basic_clip_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::paint::clip_props() const noexcept {
		...
		template<class GraphicsSurfaces>
		inline basic_brush<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::stroke::brush() const noexcept {
			return GraphicsSurfaces::surfaces::brush(_Data);
		}
		template<class GraphicsSurfaces>
		...
		template<class GraphicsSurfaces>
		inline basic_interpreted_path<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::stroke::path() const noexcept {
		...
		template<class GraphicsSurfaces>
		inline basic_stroke_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::stroke::stroke_props() const noexcept {
			return GraphicsSurfaces::surfaces::stroke_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::stroke::dashes(const basic_dashes<GraphicsSurfaces>& d) noexcept {
			GraphicsSurfaces::surfaces::dashes(_Data, d);
		}
		template<class GraphicsSurfaces>
		inline basic_dashes<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::stroke::dashes() const noexcept {
		...
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::stroke::brush_props(const basic_brush_props<GraphicsSurfaces>& bp) noexcept {
			GraphicsSurfaces::surfaces::brush_props(_Data, bp);
		}
		template<class GraphicsSurfaces>
		inline basic_brush_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::stroke::brush_props() const noexcept {
			return GraphicsSurfaces::surfaces::brush_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::stroke::render_props(const basic_render_props<GraphicsSurfaces>& rp) noexcept {
			GraphicsSurfaces::surfaces::render_props(_Data, rp);
		}
		template<class GraphicsSurfaces>
		inline basic_render_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::stroke::render_props() const noexcept {
			return GraphicsSurfaces::surfaces::render_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::stroke::clip_props(const basic_clip_props<GraphicsSurfaces>& cl) noexcept {
			GraphicsSurfaces::surfaces::clip_props(_Data, cl);
		}
		template<class GraphicsSurfaces>
		inline basic_clip_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::stroke::clip_props() const noexcept {
			return GraphicsSurfaces::surfaces::clip_props(_Data);
		}
		template<class GraphicsSurfaces>
		...
		template<class GraphicsSurfaces>
		inline basic_commands<GraphicsSurfaces>::fill::fill(const basic_brush<GraphicsSurfaces>& b, const basic_interpreted_path<GraphicsSurfaces>& ip, const basic_brush_props<GraphicsSurfaces>& bp, const basic_render_props<GraphicsSurfaces>& rp, const basic_clip_props<GraphicsSurfaces>& cl) noexcept
			: _Data(GraphicsSurfaces::surfaces::create_fill(b, ip, bp, rp, cl)) {
		}
		template<class GraphicsSurfaces>
		inline basic_commands<GraphicsSurfaces>::fill::fill(reference_wrapper<basic_image_surface<GraphicsSurfaces>> sfc, const basic_brush<GraphicsSurfaces>& b, const basic_interpreted_path<GraphicsSurfaces>& ip, const basic_brush_props<GraphicsSurfaces>& bp, const basic_render_props<GraphicsSurfaces>& rp, const basic_clip_props<GraphicsSurfaces>& cl) noexcept
		...
		template<class GraphicsSurfaces>
		inline basic_brush<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::fill::brush() const noexcept {
			return GraphicsSurfaces::surfaces::brush(_Data);
		}
		template<class GraphicsSurfaces>
		...
		template<class GraphicsSurfaces>
		inline basic_interpreted_path<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::fill::path() const noexcept {
			return GraphicsSurfaces::surfaces::path(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::fill::brush_props(const basic_brush_props<GraphicsSurfaces>& bp) noexcept {
			GraphicsSurfaces::surfaces::brush_props(_Data, bp);
		}
		template<class GraphicsSurfaces>
		inline basic_brush_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::fill::brush_props() const noexcept {
			return GraphicsSurfaces::surfaces::brush_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::fill::render_props(const basic_render_props<GraphicsSurfaces>& rp) noexcept {
			GraphicsSurfaces::surfaces::render_props(_Data, rp);
		}
		template<class GraphicsSurfaces>
		inline basic_render_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::fill::render_props() const noexcept {
			return GraphicsSurfaces::surfaces::render_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::fill::clip_props(const basic_clip_props<GraphicsSurfaces>& cl) noexcept {
			GraphicsSurfaces::surfaces::clip_props(_Data, cl);
		}
		template<class GraphicsSurfaces>
		inline basic_clip_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::fill::clip_props() const noexcept {
			return GraphicsSurfaces::surfaces::clip_props(_Data);
		}
		template<class GraphicsSurfaces>
		...
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::mask::brush(const basic_brush<GraphicsSurfaces>& b) noexcept {
			GraphicsSurfaces::surfaces::brush(_Data, b);
		}
		template<class GraphicsSurfaces>
		inline basic_brush<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::mask::brush() const noexcept {
			return GraphicsSurfaces::surfaces::brush(_Data);
		}
		template<class GraphicsSurfaces>
		...
		template<class GraphicsSurfaces>
		inline basic_brush<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::mask::mask_brush() const noexcept {
			return GraphicsSurfaces::surfaces::mask_brush(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::mask::brush_props(const basic_brush_props<GraphicsSurfaces>& bp) noexcept {
			GraphicsSurfaces::surfaces::brush_props(_Data, bp);
		}
		template<class GraphicsSurfaces>
		inline basic_brush_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::mask::brush_props() const noexcept {
			return GraphicsSurfaces::surfaces::brush_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::mask::mask_props(const basic_mask_props<GraphicsSurfaces>& mp) noexcept {
			GraphicsSurfaces::surfaces::mask_props(_Data, mp);
		}
		template<class GraphicsSurfaces>
		inline basic_mask_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::mask::mask_props() const noexcept {
			return GraphicsSurfaces::surfaces::mask_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::mask::render_props(const basic_render_props<GraphicsSurfaces>& rp) noexcept {
			GraphicsSurfaces::surfaces::render_props(_Data, rp);
		}
		template<class GraphicsSurfaces>
		inline basic_render_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::mask::render_props() const noexcept {
			return GraphicsSurfaces::surfaces::render_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::mask::clip_props(const basic_clip_props<GraphicsSurfaces>& cl) noexcept {
			GraphicsSurfaces::surfaces::clip_props(_Data, cl);
		}
		template<class GraphicsSurfaces>
		inline basic_clip_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::mask::clip_props() const noexcept {
			return GraphicsSurfaces::surfaces::clip_props(_Data);
		}
		template<class GraphicsSurfaces>
		...
		template<class GraphicsSurfaces>
		inline basic_brush<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::draw_text::brush() const noexcept {
			return GraphicsSurfaces::surfaces::brush(_Data);
		}
		template<class GraphicsSurfaces>
		...
		template<class GraphicsSurfaces>
		inline basic_font<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::draw_text::font() const noexcept {
			return GraphicsSurfaces::surfaces::font(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::draw_text::text(string t) noexcept {
			GraphicsSurfaces::surfaces::text(_Data, t);
		}
		template<class GraphicsSurfaces>
		inline string basic_commands<GraphicsSurfaces>::draw_text::text() const noexcept {
			return GraphicsSurfaces::surfaces::text(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::draw_text::text_props(const basic_text_props<GraphicsSurfaces>& tp) noexcept {
			GraphicsSurfaces::surfaces::text_props(_Data, tp);
		}
		template<class GraphicsSurfaces>
		inline basic_text_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::draw_text::text_props() const noexcept {
			return GraphicsSurfaces::surfaces::text_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::draw_text::brush_props(const basic_brush_props<GraphicsSurfaces>& bp) noexcept {
			GraphicsSurfaces::surfaces::brush_props(_Data, bp);
		}
		template<class GraphicsSurfaces>
		inline basic_brush_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::draw_text::brush_props() const noexcept {
			return GraphicsSurfaces::surfaces::brush_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::draw_text::stroke_props(const basic_stroke_props<GraphicsSurfaces>& sp) noexcept {
			GraphicsSurfaces::surfaces::stroke_props(_Data, sp);
		}
		template<class GraphicsSurfaces>
		inline basic_stroke_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::draw_text::stroke_props() const noexcept {
			return GraphicsSurfaces::surfaces::stroke_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::draw_text::dashes(const basic_dashes<GraphicsSurfaces>& d) noexcept {
			GraphicsSurfaces::surfaces::dashes(_Data);
		}
		template<class GraphicsSurfaces>
		inline basic_dashes<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::draw_text::dashes() const noexcept {
			return GraphicsSurfaces::surfaces::dashes(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::draw_text::render_props(const basic_render_props<GraphicsSurfaces>& rp) noexcept {
			GraphicsSurfaces::surfaces::render_props(_Data, rp);
		}
		template<class GraphicsSurfaces>
		inline basic_render_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::draw_text::render_props() const noexcept {
			return GraphicsSurfaces::surfaces::render_props(_Data);
		}
		template<class GraphicsSurfaces>
		inline void basic_commands<GraphicsSurfaces>::draw_text::clip_props(const basic_clip_props<GraphicsSurfaces>& cl) noexcept {
			GraphicsSurfaces::surfaces::clip_props(_Data, cl);
		}
		template<class GraphicsSurfaces>
		inline basic_clip_props<GraphicsSurfaces> basic_commands<GraphicsSurfaces>::draw_text::clip_props() const noexcept {
			return GraphicsSurfaces::surfaces::clip_props(_Data);
		}
