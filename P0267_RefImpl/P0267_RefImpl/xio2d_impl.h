	...
	namespace experimental {
		namespace io2d {
			inline namespace v1 {
				...
				template <class T>
				template <class GraphicsMath, class Allocator>
				inline interpreted_path<T>::interpreted_path(const path_builder<GraphicsMath, Allocator>& pf)
					: _Path_impl(pf)
				{}
				...
				// Surfaces
				template <class GraphicsMath>
				inline constexpr render_props<GraphicsMath>::render_props() noexcept {}

				template <class GraphicsMath>
				inline constexpr render_props<GraphicsMath>::render_props(antialias a, const typename GraphicsMath::matrix_2d& m,
				...
				template <class GraphicsMath>
				inline constexpr void render_props<GraphicsMath>::antialiasing(antialias a) noexcept {
					_Antialiasing = a;
				}

				template <class GraphicsMath>
				inline constexpr void render_props<GraphicsMath>::compositing(compositing_op co) noexcept {
					_Compositing = co;
				}

				template <class GraphicsMath>
				inline constexpr void render_props<GraphicsMath>::surface_matrix(const typename GraphicsMath::matrix_2d& m) noexcept {
					_Matrix = m;
				}

				template <class GraphicsMath>
				inline constexpr antialias render_props<GraphicsMath>::antialiasing() const noexcept {
					return _Antialiasing;
				}

				template <class GraphicsMath>
				inline constexpr compositing_op render_props<GraphicsMath>::compositing() const noexcept {
					return _Compositing;
				}

				template <class GraphicsMath>
				inline constexpr typename GraphicsMath::matrix_2d render_props<GraphicsMath>::surface_matrix() const noexcept {
					return _Matrix;
				}

				template <class GraphicsMath>
				constexpr brush_props<GraphicsMath>::brush_props(experimental::io2d::wrap_mode w,
					experimental::io2d::filter fi,
					experimental::io2d::fill_rule fr,
					const typename GraphicsMath::matrix_2d& m) noexcept
					: _Wrap_mode(w)
					, _Filter(fi)
					, _Fill_rule(fr)
					, _Matrix(m) {
				...
				template <class GraphicsMath>
				inline constexpr void brush_props<GraphicsMath>::filter(experimental::io2d::filter fi) noexcept {
					_Filter = fi;
				}

				template <class GraphicsMath>
				inline constexpr void brush_props<GraphicsMath>::wrap_mode(experimental::io2d::wrap_mode w) noexcept {
					_Wrap_mode = w;
				}

				template <class GraphicsMath>
				inline constexpr void brush_props<GraphicsMath>::fill_rule(experimental::io2d::fill_rule fr) noexcept {
					_Fill_rule = fr;
				}

				template <class GraphicsMath>
				inline constexpr void brush_props<GraphicsMath>::brush_matrix(const typename GraphicsMath::matrix_2d& m) noexcept {
					_Matrix = m;
				}

				template <class GraphicsMath>
				inline constexpr experimental::io2d::filter brush_props<GraphicsMath>::filter() const noexcept {
					return _Filter;
				}

				template <class GraphicsMath>
				inline constexpr experimental::io2d::wrap_mode brush_props<GraphicsMath>::wrap_mode() const noexcept {
					return _Wrap_mode;
				}

				template <class GraphicsMath>
				inline constexpr experimental::io2d::fill_rule brush_props<GraphicsMath>::fill_rule() const noexcept {
					return _Fill_rule;
				}

				template <class GraphicsMath>
				inline constexpr typename GraphicsMath::matrix_2d brush_props<GraphicsMath>::brush_matrix() const noexcept {
					return _Matrix;
				}

				template <class T>
				template <class GraphicsMath, class Allocator>
				inline clip_props<T>::clip_props(const path_builder<GraphicsMath, Allocator> &pf,
					io2d::fill_rule fr)
				...
				template <class T>
				template <class GraphicsMath>
				inline clip_props<T>::clip_props(const bounding_box<GraphicsMath>& r,
					experimental::io2d::fill_rule fr)
					: _Clip()
					, _Fill_rule(fr) {
					path_builder<> clip;
				...
				template <class T>
				template <class GraphicsMath, class Allocator>
				inline void clip_props<T>::clip(const path_builder<GraphicsMath, Allocator>& pf) {
					_Clip = interpreted_path(pf);
				}
				...
				template <class GraphicsMath>
				inline constexpr mask_props<GraphicsMath>::mask_props(experimental::io2d::wrap_mode w,
					experimental::io2d::filter fi,
					const typename GraphicsMath::matrix_2d& m) noexcept
					: _Wrap_mode(w)
					, _Filter(fi)
				...
				template <class GraphicsMath>
				inline constexpr void mask_props<GraphicsMath>::wrap_mode(experimental::io2d::wrap_mode w) noexcept {
					_Wrap_mode = w;
				}
				template <class GraphicsMath>
				inline constexpr void mask_props<GraphicsMath>::filter(experimental::io2d::filter fi) noexcept {
					_Filter = fi;
				}
				template <class GraphicsMath>
				inline constexpr void mask_props<GraphicsMath>::mask_matrix(const typename GraphicsMath::matrix_2d& m) noexcept {
					_Matrix = m;
				}

				template <class GraphicsMath>
				inline constexpr experimental::io2d::wrap_mode mask_props<GraphicsMath>::wrap_mode() const noexcept {
					return _Wrap_mode;
				}
				template <class GraphicsMath>
				inline constexpr experimental::io2d::filter mask_props<GraphicsMath>::filter() const noexcept {
					return _Filter;
				}
				template <class GraphicsMath>
				inline constexpr typename GraphicsMath::matrix_2d mask_props<GraphicsMath>::mask_matrix() const noexcept {
					return _Matrix;
				}
				...
				handler<T>::handler(display_surface<GraphicsMath, U>& ds, int preferredDisplayWidth, int preferredDisplayHeight, experimental::io2d::refresh_rate rr, float desiredFramerate)
				...
				template <class GraphicsMath, class T>
				inline surface<GraphicsMath, T>::surface(::std::experimental::io2d::format fmt, int width, int height)
					: _Surface_impl(make_unique<T::renderer_surface>(fmt, width, height)) {}

				template <class GraphicsMath, class T>
				inline surface<GraphicsMath, T>::surface(native_handle_type nh, ::std::experimental::io2d::format fmt)
					: _Surface_impl(make_unique<T::renderer_surface>(nh, fmt)) {}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::clear()
				{
					_Surface_impl->clear();
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::flush()
				{
					_Surface_impl->flush();
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::flush(error_code& ec) noexcept
				{
					_Surface_impl->flush(ec);
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::mark_dirty()
				{
					_Surface_impl->mark_dirty();
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::mark_dirty(error_code& ec) noexcept
				{
					_Surface_impl->mark_dirty(ec);
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::mark_dirty(const bounding_box<GraphicsMath>& extents)
				{
					_Surface_impl->mark_dirty(extents);
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::mark_dirty(const bounding_box<GraphicsMath>& extents, error_code& ec) noexcept
				{
					_Surface_impl->mark_dirty(extents, ec);
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::paint(const brush<GraphicsMath, T>& b, const optional<brush_props<GraphicsMath>>& bp, const optional<render_props<GraphicsMath>>& rp, const optional<clip_props<T>>& cl)
				{
				...
				inline void surface<GraphicsMath, T>::stroke(const brush<GraphicsMath, T>& b, const path_builder<GraphicsMath, Allocator>& pb, const optional<brush_props<GraphicsMath>>& bp, const optional<stroke_props>& sp, const optional<dashes>& d, const optional<render_props<GraphicsMath>>& rp, const optional<clip_props<T>>& cl)
				{
					_Surface_impl->stroke(b.native_handle(), pb, bp, sp, d, rp, cl);
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::stroke(const brush<GraphicsMath, T>& b, const interpreted_path<T>& pg, const optional<brush_props<GraphicsMath>>& bp, const optional<stroke_props>& sp, const optional<dashes>& d, const optional<render_props<GraphicsMath>>& rp, const optional<clip_props<T>>& cl)
				{
				...
				template <class GraphicsMath, class T>
				template <class Allocator>
				inline void surface<GraphicsMath, T>::fill(const brush<GraphicsMath, T>& b, const path_builder<GraphicsMath, Allocator>& pb, const optional<brush_props<GraphicsMath>>& bp, const optional<render_props<GraphicsMath>>& rp, const optional<clip_props<T>>& cl)
				{
					_Surface_impl->fill(b.native_handle(), pb, bp, rp, cl);
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::fill(const brush<GraphicsMath, T>& b, const interpreted_path<T>& pg, const optional<brush_props<GraphicsMath>>& bp, const optional<render_props<GraphicsMath>>& rp, const optional<clip_props<T>>& cl)
				{
					_Surface_impl->fill(b.native_handle(), pg, bp, rp, cl);
				}

				template <class GraphicsMath, class T>
				inline void surface<GraphicsMath, T>::mask(const brush<GraphicsMath, T>& b, const brush<GraphicsMath, T>& mb, const optional<brush_props<GraphicsMath>>& bp, const optional<mask_props<GraphicsMath>>& mp, const optional<render_props<GraphicsMath>>& rp, const optional<clip_props<T>>& cl)
				{
				...
				template <class GraphicsMath, class T>
				inline image_surface<GraphicsMath, T>::image_surface(io2d::format fmt, int width, int height)
					: surface<T>(fmt, width, height)
					, _Image_surface_impl(surface<GraphicsMath, T>::_Surface_impl.get())
				{}

#ifdef _Filesystem_support_test
				template <class GraphicsMath, class T>
				inline image_surface<GraphicsMath, T>::image_surface(filesystem::path f, image_file_format i, io2d::format fmt)
					: surface<T>({ nullptr, nullptr }, fmt)
					, _Image_surface_impl(surface<GraphicsMath, T>::_Surface_impl.get(), f, i, fmt)
				{}
#else
				template <class GraphicsMath, class T>
				inline image_surface<GraphicsMath, T>::image_surface(::std::string f, experimental::io2d::format fmt, image_file_format idf)
					: surface<T>({ nullptr, nullptr }, fmt)
					, _Image_surface_impl(surface<GraphicsMath, T>::_Surface_impl.get(), f, i, fmt)
				{}
#endif
...
#ifdef _Filesystem_support_test
				template <class GraphicsMath, class T>
				inline void image_surface<GraphicsMath, T>::save(filesystem::path p, image_file_format i)
				{
					_Image_surface_impl.save(p, i);
				}
#else
				template <class GraphicsMath, class T>
				inline void image_surface<GraphicsMath, T>::save(::std::string f, image_file_format i);
				{
				...
				template <class GraphicsMath, class T>
				inline void image_surface<GraphicsMath, T>::map(const function<void(mapped_surface<GraphicsMath, T>&)>& action)
				{
					_Image_surface_impl.map(action);
				}

				template <class GraphicsMath, class T>
				inline int image_surface<GraphicsMath, T>::max_width() noexcept
				{
					return T::renderer_image_surface::max_width();
				}

				template <class GraphicsMath, class T>
				inline int image_surface<GraphicsMath, T>::max_height() noexcept
				{
					return T::renderer_image_surface::max_height();
				}

				template <class GraphicsMath, class T>
				inline io2d::format image_surface<GraphicsMath, T>::format() const noexcept
				{
					return _Image_surface_impl.format();
				}

				template <class GraphicsMath, class T>
				inline int image_surface<GraphicsMath, T>::width() const noexcept
				{
					return _Image_surface_impl.width();
				}

				template <class GraphicsMath, class T>
				inline int image_surface<GraphicsMath, T>::height() const noexcept
				{
				...
				template <class GraphicsMath, class T>
				inline display_surface<GraphicsMath, T>::display_surface(int preferredWidth, int preferredHeight, io2d::format preferredFormat, io2d::scaling scl)
				...
				template <class GraphicsMath, class T>
				inline display_surface<GraphicsMath, T>::display_surface(int preferredWidth, int preferredHeight, io2d::format preferredFormat, error_code& ec, io2d::scaling scl) noexcept
					: surface(preferredFormat, preferredWidth, preferredHeight)
				...
				template <class GraphicsMath, class T>
				template <class U>
				inline void display_surface<GraphicsMath, T>::make_native_surface(U&& context)
				{
					_Display_surface_impl.make_native_surface(context);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::make_impl_surface()
				{
					_Display_surface_impl.make_impl_surface();
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::draw_callback(const function<void(display_surface<GraphicsMath, T>& sfc)>& fn)
				{
					_Display_surface_impl.draw_callback(fn);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::invoke_draw_callback(display_point dp)
				{
					_Display_surface_impl.invoke_draw_callback(dp, *this);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::size_change_callback(const function<void(display_surface<GraphicsMath, T>& sfc)>& fn)
				{
					_Display_surface_impl.size_change_callback(fn);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::invoke_size_change_callback()
				{
					_Display_surface_impl.invoke_size_change_callback(*this);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::dimensions(display_point dp)
				{
					_Display_surface_impl.dimensions(dp);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::dimensions(display_point dp, error_code& ec) noexcept
				{
					_Display_surface_impl.dimensions(dp, ec);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::scaling(experimental::io2d::scaling scl) noexcept
				{
					_Display_surface_impl.scaling(scl);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::user_scaling_callback(const function<experimental::io2d::bounding_box<GraphicsMath>(const display_surface&, bool&)>& fn)
				{
					_Display_surface_impl.user_scaling_callback(fn);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::letterbox_brush(const optional<brush<GraphicsMath, T>>& b, const optional<brush_props<GraphicsMath>> bp) noexcept
				{
					_Display_surface_impl.letterbox_brush(b, bp);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::auto_clear(bool val) noexcept
				{
					_Display_surface_impl.auto_clear(val);
				}

				template <class GraphicsMath, class T>
				inline void display_surface<GraphicsMath, T>::redraw_required() noexcept
				{
					_Display_surface_impl.redraw_required();
				}

				template <class GraphicsMath, class T>
				inline bool display_surface<GraphicsMath, T>::reset_redraw_request() noexcept
				{
					return _Display_surface_impl.reset_redraw_request();
				}

				template <class GraphicsMath, class T>
				inline experimental::io2d::format display_surface<GraphicsMath, T>::format() const noexcept
				{
					return _Display_surface_impl.format();
				}

				template <class GraphicsMath, class T>
				inline display_point display_surface<GraphicsMath, T>::dimensions() const noexcept
				{
					return _Display_surface_impl.dimensions();
				}

				template <class GraphicsMath, class T>
				inline experimental::io2d::scaling display_surface<GraphicsMath, T>::scaling() const noexcept
				{
					return _Display_surface_impl.scaling();
				}

				template <class GraphicsMath, class T>
				inline function<experimental::io2d::bounding_box<GraphicsMath>(const display_surface<GraphicsMath, T>&, bool&)> display_surface<GraphicsMath, T>::user_scaling_callback() const
				{
					return _Display_surface_impl.user_scaling_callback();
				}

				template <class GraphicsMath, class T>
				inline function<experimental::io2d::bounding_box<GraphicsMath>(const display_surface<GraphicsMath, T>&, bool&)> display_surface<GraphicsMath, T>::user_scaling_callback(error_code& ec) const noexcept
				{
					return _Display_surface_impl.user_scaling_callback(ec);
				}

				template <class GraphicsMath, class T>
				inline optional<brush<GraphicsMath, T>> display_surface<GraphicsMath, T>::letterbox_brush() const noexcept
				{
					return _Display_surface_impl.letterbox_brush();
				}

				template <class GraphicsMath, class T>
				inline optional<brush_props<GraphicsMath>> display_surface<GraphicsMath, T>::letterbox_brush_props() const noexcept
				{
					return _Display_surface_impl.letterbox_brush_props();
				}

				template <class GraphicsMath, class T>
				inline bool display_surface<GraphicsMath, T>::auto_clear() const noexcept
				{
