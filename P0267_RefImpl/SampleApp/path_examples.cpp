...
namespace path_test {
	...
	void path_test_5() {
		...
		pb.new_figure({ 170.0F, 150.0F });
		pb.matrix(rot * scl);
		pb.rel_quadratic_curve({ 20.0F, -30.0F }, { 20.0F, 30.0F });
		pb.revert_matrix();

		pb.new_figure({ 230.0F, 150.0F });
		pb.matrix(scl * rot);
		pb.rel_quadratic_curve({ 20.0F, -30.0F }, { 20.0F, 30.0F });
		pb.revert_matrix();

		pb.new_figure({ 290.0F, 150.0F });
		pb.matrix(rot * trn);
		pb.rel_quadratic_curve({ 20.0F, -30.0F }, { 20.0F, 30.0F });
	...
	void path_test_8() {
		...
		pb.line({ 80.0F, 50.0F });
		pb.new_figure({ 40.0F, 150.0F });
		pb.rel_line({ 40.0F, 0.0F });
		pb.revert_matrix();
		pb.new_figure({ 60.0F, 150.0F });
