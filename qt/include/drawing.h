		...
		namespace drawing {
			...
			inline namespace v1 {
				...
				struct rgba_color {
                    ...
                    static rgba_color from_byte_values(unsigned char r, unsigned char g, unsigned char b, unsigned char a = 255u);
				...
				class path {
					...
					point _Extents_pt1;
				public:
                    typedef QPainterPath* native_handle_type;
				...
				class device {
				protected:
                    ::std::shared_ptr<QPaintEngine> _Device;
				public:
                    typedef QPaintEngine* native_handle_type;
				...
				class font_options {
                    ::std::shared_ptr<_QFontOptions> _Font_options;
				public:
                    typedef _QFontOptions* native_handle_type;
					native_handle_type native_handle() const;
				...
				class font_face {
				protected:
                    ::std::shared_ptr<QFont> _Font_face;
				public:
                    typedef QFont* native_handle_type;
					native_handle_type native_handle() const;
				...
				class scaled_font {
                    ::std::shared_ptr<QFont> _Scaled_font;
				...
				class pattern {
				public:
					typedef QBrush* native_handle_type;
				...
				private:
					...
					std::unique_ptr<QBrush> _Pattern;
...
//					static void _Cairo_release(cairo_pattern_t* pattern_builder, void* this_ptr, cairo_surface_t* surface);
				...
				protected:
                    ::std::unique_ptr<QPaintDevice> _Surface;
                    ::std::unique_ptr<QPaintEngine> _Context;
