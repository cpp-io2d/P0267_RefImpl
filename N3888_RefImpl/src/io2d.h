...
#pragma clang diagnostic pop
				...
				_IO2D_API double angle_for_point(const vector_2d& ctr, const vector_2d& pt) noexcept;
				_IO2D_API vector_2d point_for_angle(double ang, double mgn = 1.0) noexcept;
				_IO2D_API vector_2d point_for_angle(double ang, const vector_2d& rad) noexcept;
				...
				public:
					...
					_IO2D_API bool desired_frame_rate(double fps) noexcept;
					...
					_IO2D_API double desired_frame_rate() const noexcept;
					_IO2D_API double elapsed_draw_time() const noexcept;
				};

				_IO2D_API int format_stride_for_width(format format, int width) noexcept;
				_IO2D_API display_surface make_display_surface(int preferredWidth, int preferredHeight, format preferredFormat, scaling scl = scaling::letterbox, refresh_rate rr = refresh_rate::as_fast_as_possible, double desiredFramerate = 30.0);
				...
				_IO2D_API display_surface make_display_surface(int preferredWidth, int preferredHeight, format preferredFormat, int preferredDisplayWidth, int preferredDisplayHeight, scaling scl = scaling::letterbox, refresh_rate rr = refresh_rate::as_fast_as_possible, double desiredFramerate = 30.0);
