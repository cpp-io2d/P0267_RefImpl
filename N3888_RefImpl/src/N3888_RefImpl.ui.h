#pragma once
#ifndef N3888_REFIMPL_UI_H
#define N3888_REFIMPL_UI_H

const char* g_n3888_ui_as_string =  R"N3888_UI_RSLD(<?xml version="1.0" encoding="UTF-8"?>
...
With thanks to Uli Schlachter for assistance with Gtk+.
