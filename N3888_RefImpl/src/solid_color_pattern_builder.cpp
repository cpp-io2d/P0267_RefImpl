...
solid_color_pattern_builder::solid_color_pattern_builder()
	: _Lock()
...
solid_color_pattern_builder::solid_color_pattern_builder(const solid_color_pattern_builder& other)
	: _Lock()
	, _Pattern_type()
	, _Extend()
	, _Filter()
...
solid_color_pattern_builder& solid_color_pattern_builder::operator=(const solid_color_pattern_builder& other) {
	if (this != &other) {
		lock_guard<decltype(other._Lock)> olg(other._Lock);
...
pattern solid_color_pattern_builder::get_pattern() const {
	lock_guard<decltype(_Lock)> lg(_Lock);
...
extend solid_color_pattern_builder::get_extend() const {
	lock_guard<decltype(_Lock)> lg(_Lock);
	return _Extend;
}
...
filter solid_color_pattern_builder::get_filter() const {
	lock_guard<decltype(_Lock)> lg(_Lock);
	return _Filter;
}
...
matrix_2d solid_color_pattern_builder::get_matrix() const {
	lock_guard<decltype(_Lock)> lg(_Lock);
	return _Matrix;
}

rgba_color solid_color_pattern_builder::get_rgba() const {
	lock_guard<decltype(_Lock)> lg(_Lock);
	return _Color;
}
...
double solid_color_pattern_builder::get_red() const {
	lock_guard<decltype(_Lock)> lg(_Lock);
	return _Color.r;
}
...
double solid_color_pattern_builder::get_green() const {
	lock_guard<decltype(_Lock)> lg(_Lock);
	return _Color.g;
}
...
double solid_color_pattern_builder::get_blue() const {
	lock_guard<decltype(_Lock)> lg(_Lock);
	return _Color.b;
}
...
double solid_color_pattern_builder::get_alpha() const {
	return _Color.a;
}
