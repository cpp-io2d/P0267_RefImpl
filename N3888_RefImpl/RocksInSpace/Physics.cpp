...
namespace
{
	auto const max_ship_speed = 0.9F;
}
...
std::array<asteroids::physics, 2> asteroids::physics::divide(std::mt19937& gen, std::uniform_real_distribution<float>& zero_to_one) const
{
...
std::pair<asteroids::path_buffer, float> asteroids::path_from_prototype(const path_buffer& path, float s)
{
